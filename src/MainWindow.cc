...
{
	LOG(message_group::None, Location::NONE, "", "%1$s export finished: %2$s", format,
		...
		progresswidget(nullptr), includes_mtime(0), deps_mtime(0), last_parser_error_pos(-1)
{
	...
	// Preferences initialization happens on first tab creation, and depends on colorschemes from
	// editor. Any code dependent on Preferences must come after the TabManager instantiation
	...
	connect(Preferences::inst(), SIGNAL(consoleFontChanged(const QString &, uint)), this->console,
					SLOT(setFont(const QString &, uint)));
	...
	this->console->setFont(Preferences::inst()->getValue("advanced/consoleFontFamily").toString(),
	...
	connect(this->errorLogWidget, SIGNAL(openFile(QString, int)), this,
					SLOT(openFileFromPath(QString, int)));
	connect(this->console, SIGNAL(openFile(QString, int)), this,
					SLOT(openFileFromPath(QString, int)));

	connect(Preferences::inst()->ButtonConfig, SIGNAL(inputMappingChanged()),
					InputDriverManager::instance(), SLOT(onInputMappingUpdated()), Qt::UniqueConnection);
	connect(Preferences::inst()->AxisConfig, SIGNAL(inputMappingChanged()),
					InputDriverManager::instance(), SLOT(onInputMappingUpdated()), Qt::UniqueConnection);
	connect(Preferences::inst()->AxisConfig, SIGNAL(inputCalibrationChanged()),
					InputDriverManager::instance(), SLOT(onInputCalibrationUpdated()), Qt::UniqueConnection);
	connect(Preferences::inst()->AxisConfig, SIGNAL(inputGainChanged()),
					InputDriverManager::instance(), SLOT(onInputGainUpdated()), Qt::UniqueConnection);
	...
	connect(Preferences::inst(), SIGNAL(updateMouseCentricZoom(bool)), this->qglview,
					SLOT(setMouseCentricZoom(bool)));
	...
	Preferences::inst()->apply_win(); // not sure if to be commented, checked must not be
	...
	initActionIcon(fileActionNew, ":/resources/icons/svg-default/new.svg",
								 ":/resources/icons/svg-default/new-white.svg");
	initActionIcon(fileActionOpen, ":/resources/icons/svg-default/open.svg",
								 ":/resources/icons/svg-default/open-white.svg");
	initActionIcon(fileActionSave, ":/resources/icons/svg-default/save.svg",
								 ":/resources/icons/svg-default/save-white.svg");
	initActionIcon(editActionZoomTextIn, ":/resources/icons/svg-default/zoom-text-in.svg",
								 ":/resources/icons/svg-default/zoom-text-in-white.svg");
	initActionIcon(editActionZoomTextOut, ":/resources/icons/svg-default/zoom-text-out.svg",
								 ":/resources/icons/svg-default/zoom-text-out-white.svg");
	initActionIcon(designActionRender, ":/resources/icons/svg-default/render.svg",
								 ":/resources/icons/svg-default/render-white.svg");
	initActionIcon(designAction3DPrint, ":/resources/icons/svg-default/send.svg",
								 ":/resources/icons/svg-default/send-white.svg");
	initActionIcon(viewActionShowAxes, ":/resources/icons/svg-default/axes.svg",
								 ":/resources/icons/svg-default/axes-white.svg");
	initActionIcon(viewActionShowEdges, ":/resources/icons/svg-default/show-edges.svg",
								 ":/resources/icons/svg-default/show-edges-white.svg");
	initActionIcon(viewActionZoomIn, ":/resources/icons/svg-default/zoom-in.svg",
								 ":/resources/icons/svg-default/zoom-in-white.svg");
	initActionIcon(viewActionZoomOut, ":/resources/icons/svg-default/zoom-out.svg",
								 ":/resources/icons/svg-default/zoom-out-white.svg");
	initActionIcon(viewActionTop, ":/resources/icons/svg-default/view-top.svg",
								 ":/resources/icons/svg-default/view-top-white.svg");
	initActionIcon(viewActionBottom, ":/resources/icons/svg-default/view-bottom.svg",
								 ":/resources/icons/svg-default/view-bottom-white.svg");
	initActionIcon(viewActionLeft, ":/resources/icons/svg-default/view-left.svg",
								 ":/resources/icons/svg-default/view-left-white.svg");
	initActionIcon(viewActionRight, ":/resources/icons/svg-default/view-right.svg",
								 ":/resources/icons/svg-default/view-right-white.svg");
	initActionIcon(viewActionFront, ":/resources/icons/svg-default/view-front.svg",
								 ":/resources/icons/svg-default/view-front-white.svg");
	initActionIcon(viewActionBack, ":/resources/icons/svg-default/view-back.svg",
								 ":/resources/icons/svg-default/view-back-white.svg");
	initActionIcon(viewActionSurfaces, ":/resources/icons/svg-default/surface.svg",
								 ":/resources/icons/svg-default/surface-white.svg");
	initActionIcon(viewActionWireframe, ":/resources/icons/svg-default/wireframe.svg",
								 ":/resources/icons/svg-default/wireframe-white.svg");
	initActionIcon(viewActionShowCrosshairs, ":/resources/icons/svg-default/crosshairs.svg",
								 ":/resources/icons/svg-default/crosshairs-white.svg");
	initActionIcon(viewActionThrownTogether, ":/resources/icons/svg-default/throwntogether.svg",
								 ":/resources/icons/svg-default/throwntogether-white.svg");
	initActionIcon(viewActionPerspective, ":/resources/icons/svg-default/perspective.svg",
								 ":/resources/icons/svg-default/perspective-white.svg");
	initActionIcon(viewActionOrthogonal, ":/resources/icons/svg-default/orthogonal.svg",
								 ":/resources/icons/svg-default/orthogonal-white.svg");
	initActionIcon(designActionPreview, ":/resources/icons/svg-default/preview.svg",
								 ":/resources/icons/svg-default/preview-white.svg");
	initActionIcon(viewActionAnimate, ":/resources/icons/svg-default/animate.svg",
								 ":/resources/icons/svg-default/animate-white.svg");
	initActionIcon(fileActionExportSTL, ":/resources/icons/svg-default/export-stl.svg",
								 ":/resources/icons/svg-default/export-stl-white.svg");
	initActionIcon(fileActionExportAMF, ":/resources/icons/svg-default/export-amf.svg",
								 ":/resources/icons/svg-default/export-amf-white.svg");
	initActionIcon(fileActionExport3MF, ":/resources/icons/svg-default/export-3mf.svg",
								 ":/resources/icons/svg-default/export-3mf-white.svg");
	initActionIcon(fileActionExportOFF, ":/resources/icons/svg-default/export-off.svg",
								 ":/resources/icons/svg-default/export-off-white.svg");
	initActionIcon(fileActionExportDXF, ":/resources/icons/svg-default/export-dxf.svg",
								 ":/resources/icons/svg-default/export-dxf-white.svg");
	initActionIcon(fileActionExportSVG, ":/resources/icons/svg-default/export-svg.svg",
								 ":/resources/icons/svg-default/export-svg-white.svg");
	initActionIcon(fileActionExportCSG, ":/resources/icons/svg-default/export-csg.svg",
								 ":/resources/icons/svg-default/export-csg-white.svg");
	initActionIcon(fileActionExportPDF, ":/resources/icons/svg-default/export-pdf.svg",
								 ":/resources/icons/svg-default/export-pdf-white.svg");
	initActionIcon(fileActionExportImage, ":/resources/icons/svg-default/export-png.svg",
								 ":/resources/icons/svg-default/export-png-white.svg");
	initActionIcon(viewActionViewAll, ":/resources/icons/svg-default/zoom-all.svg",
								 ":/resources/icons/svg-default/zoom-all-white.svg");
	initActionIcon(editActionUndo, ":/resources/icons/svg-default/undo.svg",
								 ":/resources/icons/svg-default/undo-white.svg");
	initActionIcon(editActionRedo, ":/resources/icons/svg-default/redo.svg",
								 ":/resources/icons/svg-default/redo-white.svg");
	initActionIcon(editActionUnindent, ":/resources/icons/svg-default/unindent.svg",
								 ":/resources/icons/svg-default/unindent-white.svg");
	initActionIcon(editActionIndent, ":/resources/icons/svg-default/indent.svg",
								 ":/resources/icons/svg-default/indent-white.svg");
	initActionIcon(viewActionResetView, ":/resources/icons/svg-default/reset-view.svg",
								 ":/resources/icons/svg-default/reset-view-white.svg");
	initActionIcon(viewActionShowScaleProportional, ":/resources/icons/svg-default/scalemarkers.svg",
								 ":/resources/icons/svg-default/scalemarkers-white.svg");
	...
	updateWindowSettings(hideConsole, hideEditor, hideCustomizer, hideErrorLog, hideEditorToolbar,
											 hide3DViewToolbar);
	...
	connect(this->errorLogDock, SIGNAL(topLevelChanged(bool)), this,
					SLOT(errorLogTopLevelChanged(bool)));
	...
	// handle the hide/show of exportSTL action in view toolbar according to the visibility of editor
	// dock
 ...
 */
void MainWindow::updateWindowSettings(bool console, bool editor, bool customizer, bool errorLog,
																			bool editorToolbar, bool viewToolbar)
{
...
void MainWindow::compile(bool reload, bool forcedone)
{
	...
	OpenSCAD::parameterCheck =
			Preferences::inst()->getValue("advanced/enableParameterCheck").toBool();
	OpenSCAD::rangeCheck =
			Preferences::inst()->getValue("advanced/enableParameterRangeCheck").toBool();
	...
	try {
		...
		// Parsing and dependency handling must run to completion even with stop on errors to prevent
		// auto reload picking up where it left off, thwarting the stop, so we turn off exceptions in
		// PRINT.
		...
		if (this->root_file) {
			...
			if (mtime > this->deps_mtime) {
				...
				LOG(message_group::None, Location::NONE, "", "Used file cache size: %1$d files",
...
void MainWindow::updateCompileResult()
{
	...
	msg += _(" For details see the <a href=\"#errorlog\">error log</a> and <a "
...
void MainWindow::instantiateRoot()
{
	...
	if (this->root_file) {
		...
		auto suffix_val = file_context->lookup_local_variable("$export_suffix");
		this->custom_export_suffix =
				suffix_val.has_value() ? QString::fromStdString(suffix_val->toString()) : QString();
...
void MainWindow::compileCSG()
{
	...
	try {
		...
		if (highlight_terms.size() > 0) {
			LOG(message_group::None, Location::NONE, "", "Compiling highlights (%1$d CSG Trees)...",
		...
		if (background_terms.size() > 0) {
			LOG(message_group::None, Location::NONE, "", "Compiling background (%1$d CSG Trees)...",
		...
		if (this->root_products && (this->root_products->size() >
			...
			LOG(message_group::UI_Warning, Location::NONE, "", "Normalized tree has %1$d elements!",
			...
			this->opencsgRenderer = new OpenCSGRenderer(this->root_products, this->highlights_products,
...
void MainWindow::writeBackup(QFile *file)
{
	...
	LOG(message_group::None, Location::NONE, "", "Saved backup file: %1$s",
...
void MainWindow::actionShowLibraryFolder()
{
	...
	if (!fs::exists(path)) {
		LOG(message_group::UI_Warning, Location::NONE, "", "Library path %1$s doesn't exist. Creating",
				path);
...
{
	this->findInputField->setFindCount(
			activeEditor->updateFindIndicators(this->findInputField->text()));
	this->processEvents();
...
void MainWindow::setRenderVariables(ContextHandle<BuiltinContext> &context)
{
	...
	context->set_variable("$vpt",
												Value(VectorType(context->session(), camVpt.x(), camVpt.y(), camVpt.z())));
	auto camVpr = qglview->cam.getVpr();
	context->set_variable("$vpr",
												Value(VectorType(context->session(), camVpr.x(), camVpr.y(), camVpr.z())));
...
void MainWindow::parseTopLevelDocument()
{
	...
	this->root_file =
			parse(this->parsed_file, fulltext, fname, fname, false) ? this->parsed_file : nullptr;
...
void MainWindow::action3DPrint()
{
	...
	case print_service_t::PRINT_SERVICE:
		LOG(message_group::None, Location::NONE, "", "Sending design to print service %1$s...",
				printService->getDisplayName().toStdString());
		sendToPrintService();
		break;
...
ExportInfo createExportInfo(FileFormat format, const QString &exportFilename,
...
void MainWindow::sendToOctoPrint()
{
	...
	if (octoPrint.url().trimmed().isEmpty()) {
		LOG(message_group::Error, Location::NONE, "",
				"OctoPrint connection not configured. Please check preferences.");
		return;
	}

	const QString fileFormat =
			QString::fromStdString(Settings::Settings::octoPrintFileFormat.value());
	...
	ExportInfo exportInfo =
			createExportInfo(exportFileFormat, exportFileName, activeEditor->filepath);
	...
	try {
		...
		const QString fileUrl =
				octoPrint.upload(exportFileName, userFileName,
												 [this](double v) -> bool { return network_progress_func(v); });
...
void MainWindow::sendToPrintService()
{
	...
	// Create a name that the order process will use to refer to the file. Base it off of the project
	// name
	...
	if (fileContentBase64.length() > PrintService::inst()->getFileSizeLimit()) {
		const auto msg = QString{_("Exported design exceeds the service upload limit of (%1 MB).")}.arg(
				PrintService::inst()->getFileSizeLimitMB());
	...
	try {
		...
		const QString partUrl =
				PrintService::inst()->upload(userFacingName, fileContentBase64,
																		 [this](double v) -> bool { return network_progress_func(v); });
...
void MainWindow::actionRenderDone(shared_ptr<const Geometry> root_geom)
{
	...
	if (Preferences::inst()->getValue("advanced/enableSoundNotification").toBool() &&
			Preferences::inst()->getValue("advanced/timeThresholdOnRenderCompleteSound").toUInt() <=
					ms.count() / 1000) {
	...
	if (result) {
		...
		for (const auto *step : path) {
			...
			if (!libpath.empty()) {
				...
				auto relname =
						boostfs_uncomplete(location.filePath(),
															 fs::path(activeEditor->filepath.toStdString()).parent_path())
								.generic_string();
	...
	e->setPlainText(
			QString("\nCSG before normalization:\n%1\n\n\nCSG after normalization:\n%2\n\n\nCSG "
					...
					.arg(QString::fromStdString(this->csgRoot ? this->csgRoot->dump() : NA),
							 ...
							 QString::fromStdString(this->highlights_products ? this->highlights_products->dump()
																																: NA),
							 QString::fromStdString(this->background_products ? this->background_products->dump()
																																: NA)));
...
void MainWindow::actionCheckValidity()
{
	...
	if (!this->root_geom) {
		LOG(message_group::None, Location::NONE, "",
				"Nothing to validate! Try building first (press F6).");
		clearCurrentOutput();
		return;
	}
...
bool MainWindow::canExport(unsigned int dim)
{
	...
	if (this->root_geom->getDimension() != dim) {
		LOG(message_group::UI_Error, Location::NONE, "",
	...
	if (N && !N->p3->is_simple()) {
		LOG(message_group::UI_Warning, Location::NONE, "",
...
void MainWindow::actionExportCSG()
{
	...
	if (!fstream.is_open()) {
		LOG(message_group::None, Location::NONE, "", "Can't open file \"%1$s\" for export",
...
void MainWindow::actionExportImage()
{
	...
	auto img_filename = QFileDialog::getSaveFileName(this, _("Export Image"), exportPath(suffix),
																									 _("PNG Files (*.png)"));
...
void MainWindow::on_editorDock_visibilityChanged(bool)
{
	...
	if (editorDock->isVisible())
		viewerToolBar->removeAction(this->fileActionExportSTL);
	else {
